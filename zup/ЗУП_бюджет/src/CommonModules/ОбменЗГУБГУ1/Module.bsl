////////////////////////////////////////////////////////////////////////////////
// Подсистема "Обмен ЗГУ 3.0 и БГУ 1.0"
...
// Определяет, используется ли обмен ЗГУ ред. 3 - БГУ ред. 1 для конкретной организации.
//
// Параметры
...
Процедура ОбработкаРегистрацииНачальнойВыгрузкиДанных(Знач Получатель, СтандартнаяОбработка, Отбор) Экспорт
	...
	Если Получатель.Метаданные().Имя = "ОбменЗГУБГУ1" Тогда
...
Функция НастройкиОбмена()
	...
	ИспользованиеОбмена.ИспользуетсяОбменПоВсемОрганизациям = Константы.ИспользоватьОбменЗГУБГУ1ПоВсемОрганизациям.Получить();
	...
	|ИЗ
	|	РегистрСведений.ИспользованиеОбменаЗГУБГУ1ПоОрганизациям КАК ИспользованиеОбмена
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ИспользованиеОбменаЗГУБГУ1ПоОрганизациям КАК ИспользованиеОбмена
