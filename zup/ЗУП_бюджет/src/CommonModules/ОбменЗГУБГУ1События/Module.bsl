...
Процедура ЗаписатьНастройкиИспользования(Источник, Отказ) Экспорт
	...
	Если Метаданные.ПодпискиНаСобытия.ЗаписатьНастройкиИспользованияОбменаЗГУБГУ1.Источник.Типы().Количество() <> 1 Тогда
		Возврат;
	КонецЕсли;
	...
	Если Не ЕстьОбмены Тогда
		Константы.ИспользоватьОбменЗГУБГУ1ПоВсемОрганизациям.Установить(Ложь);
		НаборЗаписей = РегистрыСведений.ИспользованиеОбменаЗГУБГУ1ПоОрганизациям.СоздатьНаборЗаписей();
	...
	Если Не Выборка.ИспользоватьОтборПоОрганизациям Тогда
		Константы.ИспользоватьОбменЗГУБГУ1ПоВсемОрганизациям.Установить(Истина);
		НаборЗаписей = РегистрыСведений.ИспользованиеОбменаЗГУБГУ1ПоОрганизациям.СоздатьНаборЗаписей();
		НаборЗаписей.Записать();
		Возврат;
	КонецЕсли;
...
Процедура ЗарегистрироватьИзменение(Источник, Отказ) Экспорт
	...
	ОбменДаннымиСобытия.МеханизмРегистрацииОбъектовПередЗаписью("ОбменЗГУБГУ1", Источник, Отказ);
...
Процедура ЗарегистрироватьИзменениеДокумента(Источник, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	ОбменДаннымиСобытия.МеханизмРегистрацииОбъектовПередЗаписьюДокумента("ОбменЗГУБГУ1", Источник, Отказ, РежимЗаписи, РежимПроведения);
...
Процедура ЗарегистрироватьИзменениеНабораЗаписей(Источник, Отказ, Замещение) Экспорт
	...
	ОбменДаннымиСобытия.МеханизмРегистрацииОбъектовПередЗаписьюРегистра("ОбменЗГУБГУ1", Источник, Отказ, Замещение);
...
Процедура ЗарегистрироватьУдаление(Источник, Отказ) Экспорт
	...
	ОбменДаннымиСобытия.МеханизмРегистрацииОбъектовПередУдалением("ОбменЗГУБГУ1", Источник, Отказ);
