...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	ЗарплатаКадрыВызовСервера.ПредставленияОснованийУвольненияОбработкаПолученияДанныхВыбора("ОснованияУвольненияСМуниципальнойСлужбы", ДанныеВыбора, Параметры, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура НачальноеЗаполнение() Экспорт
	...
	ИмяСправочника = Метаданные.Справочники.ОснованияУвольненияСМуниципальнойСлужбы.Имя;
...
Функция ИмяМакетаКлассификатора()
	Возврат "ОснованияУвольненияСМуниципальнойСлужбы";
КонецФункции
